...
public static class MeasurementManagementEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE MeasurementManagementModuleExtensionConfigurator CLASS (in the Domain.Shared project)
