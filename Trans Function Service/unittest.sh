...
curl -X GET "http://0.0.0.0:3000/sensor?message=your_message_here"
curl -X GET "http://0.0.0.0:2000/product/index"
curl -X GET "http://0.0.0.0:2000/product/details/123e4567-e89b-12d3-a456-426614174000"
curl -X GET "http://0.0.0.0:2000/sms?message=your_message_here"
